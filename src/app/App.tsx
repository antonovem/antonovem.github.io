    ...
    <div className="App">
      <header className="App-header">
        ...
        <p>
            ...
            <i>Понять реакт и тайпскрипт</i><br/><br/>
            какими технологиями хотите овладеть (если нет конкретных запросов, пропустите этот пункт)<br/>
            <i>Тайпскрипт, реакт, flex/grid верстки, в общем современное</i><br/><br/>
            какими технологиями уже владеете<br/>
            <i>php, javascript, jquery :), bitrix</i><br/><br/>
            расскажите о себе и своем опыте<br/>
